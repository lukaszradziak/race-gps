...
const byte gps_save_settings[] = {0xB5, 0x62, 0x06, 0x09, 0x0D, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x17, 0x31, 0xBF};
#endif
...
void setup()
{
  ...
  delay(100);
  ss.write(gps_save_settings, sizeof(gps_save_settings));
#endif
